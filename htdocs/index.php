...
GPON(Gigabit capable passive optical networks)とはITU-T標準化規格G.984シリーズで規定された伝送技術で、通信速度は最大2.5Gbpsまで対応しています。</li>
    ...
    音楽も動画もゲームも、ダウンロード/アップロード共にストレス無く快適にご利用頂けます。工事の後、細かい設定無くすぐにお使い頂くことが可能です。</p>
                ...
                <p>※ 記載の金額は全て税込金額です。</p>
                <p>※1 工事費44,000円を36か月の分割払い（2カ月目：1,230円、3カ月目～35カ月目：1,222円、36ヶ月目：2,444円）を、同額の工事費割引が適用されます。明細上で相殺いたしますので、工事費は実質無料となります。</p>
				...
				<p>※2年契約プラン（定期契約あり）のお申込みは2021年11月23日を持って終了いたしました。</p>
