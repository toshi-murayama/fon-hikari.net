...
<script src="https://www.googleoptimize.com/optimize.js?id=OPT-MBX3D63"></script>
...
<?php setcookie('affiliate', true, time() + 60 * 60 * 24 * 31, '/')?>
    ...
    <div id="wrap">
        <section id="top_spring">
            <article>
                <h1><img src="img/spring_cp_top.png" alt="3月31日（水） 20:59までにお申し込みの方限定！春のWキャンペーン月額半額 2,189円Amazonギフト券10,000円プレゼント" class="pc">
                <img src="img/spring_cp_top_sp.png" alt="3月31日（水） 20:59までにお申し込みの方限定！春のWキャンペーン月額半額 2,189円Amazonギフト券10,000円プレゼント" class="sp"></h1>
            </article>
        </section>
